package com.aj.service.news.config;
...
public class AjDbDataSource {
    ...
    @Primary
    public SqlSessionTemplate ajDbSqlSessionTemplate(@Qualifier("ajDbSqlSessionFactory") SqlSessionFactory sqlSessionFactory) throws Exception {
